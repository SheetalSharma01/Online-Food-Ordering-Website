console.log('Welcome to Food Corner...');
...
function displayItems() {
    ...
    const noodlesData = foodItem.filter(item=> item.category == 'noodles');
    ...
    const continentalData = foodItem.filter(item=> item.category == 'continental');
    console.log(continentalData);

    const streetData = foodItem.filter(item=> item.category == 'street');
    console.log(streetData);

    const cakeData = foodItem.filter(item=> item.category == 'cake');
    ...
    continentalData.map(item=> {
        ...
        continental.appendChild(itemCard);
    })
